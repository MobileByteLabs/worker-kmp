...
After migration, your consumer's per-platform source sets contain ZERO files for the
worker-kmp scheduling/observation/init/Koin domain. Verify:
...
- [Migration guide for v3.1.x consumers](https://github.com/MobileByteLabs/worker-kmp/wiki/v4-migration)
- [CHANGELOG](../../CHANGELOG.md) — v4.0.0 breaking changes
