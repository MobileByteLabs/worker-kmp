...
public actual fun createWebPushSubscriber(): WebPushSubscriber = StubWebPushSubscriber("WasmJs")

private class StubWebPushSubscriber(private val platform: String) : WebPushSubscriber {
